...
**Добавлен Home Hub Screen** — стартовый экран-хаб с плиточной навигацией по режимам.

Изменения в навигации:
- **Home** (Bottom Nav) — хаб с плитками: Live Detection (крупная) + File Analysis (компактная)
- **Live Detection** — push-экран (был tab в Bottom Nav), кнопка назад → Home
- **File Analysis** — push-экран, доступен с хаба (ранее через кнопку внутри Live Detection)
- Bottom Nav: Home / History / Settings (было: Detection / History / Settings)

Причина: чистый entry point, лёгкое добавление новых режимов в будущем, разделение ответственности (хаб навигации vs рабочие экраны).
