...
## Amendment 2026-03-04: Home Hub и обновлённая навигация

Приведено в соответствие с ADR-006/ADR-010 amendment 2026-03-03.

### 1. Навигация (обновлено)

3 таба Bottom Nav: **Home** | **История** | **Настройки**

- **Home** — плиточный хаб с режимами: Live Detection (крупная плитка) + File Analysis (компактная плитка)
- **История** — сохранённые наблюдения
- **Настройки** — модель, локация, разрешения

Live Detection и File Analysis — push-экраны из Home Hub (не табы).

### 6. Экраны приложения (обновлено)

| Экран | Тип | Описание |
|-------|-----|----------|
| Home | Tab (Bottom Nav) | Хаб с плитками режимов |
| History | Tab (Bottom Nav) | Сохранённые наблюдения |
